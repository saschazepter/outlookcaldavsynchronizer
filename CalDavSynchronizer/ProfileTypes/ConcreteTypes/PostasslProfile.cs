...
{
    class PostasslProfile : ProfileTypeBase
    {
        public override string Name => "Postassl";
        public override string ImageUrl { get; } = "pack://application:,,,/CalDavSynchronizer;component/Resources/ProfileLogos/logo_postassl.png";
        ...
        public override Contracts.Options CreateOptions()
        {
            ...
            data.CalenderUrl = "https://syncdav.postassl.it/";
