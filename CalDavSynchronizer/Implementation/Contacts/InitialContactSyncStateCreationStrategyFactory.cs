...
namespace CalDavSynchronizer.Implementation.Contacts
{
  ...
  {
    private static IConflictInitialSyncStateCreationStrategy<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> Create (IEntitySyncStateFactory<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> syncStateFactory, EntitySyncStateEnvironment<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> environment, ConflictResolution conflictResolution)
    {
      switch (conflictResolution)
      {
        case ConflictResolution.OutlookWins:
          return new ConflictInitialSyncStateCreationStrategyAWins<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> (syncStateFactory);
        case ConflictResolution.ServerWins:
          return new ConflictInitialSyncStateCreationStrategyBWins<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> (syncStateFactory);
    ...
    public static IInitialSyncStateCreationStrategy<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> Create (IEntitySyncStateFactory<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> syncStateFactory, EntitySyncStateEnvironment<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> environment, SynchronizationMode synchronizationMode, ConflictResolution conflictResolution)
    {
      switch (synchronizationMode)
      {
        case SynchronizationMode.MergeInBothDirections:
          ...
          return new TwoWayInitialSyncStateCreationStrategy<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> (
              syncStateFactory,
              conflictResolutionStrategy
              );
        case SynchronizationMode.ReplicateOutlookIntoServer:
        case SynchronizationMode.MergeOutlookIntoServer:
          return new OneWayInitialSyncStateCreationStrategy_AToB<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> (
              syncStateFactory,
        ...
        case SynchronizationMode.MergeServerIntoOutlook:
          return new OneWayInitialSyncStateCreationStrategy_BToA<string, DateTime, GenericComObjectWrapper<ContactItem>, string, string, vCard> (
              syncStateFactory,
