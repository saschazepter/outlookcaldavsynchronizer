...
namespace CalDavSynchronizer.Implementation.Events
{
  public class EventEntityMapper : IEntityMapper<IAppointmentItemWrapper, IICalendar, IEventSynchronizationContext>
  {
    ...
    private void Map1To2 (AppointmentItem source, IEvent target, bool isRecurrenceException, ITimeZone startIcalTimeZone, ITimeZone endIcalTimeZone, IEntityMappingLogger logger, IEventSynchronizationContext context)
    {
      ...
      target.Class = CommonEntityMapper.MapPrivacy1To2 (source.Sensitivity, _configuration.MapSensitivityPrivateToClassConfidential, _configuration.MapClassPublicToSensitivityPrivate);
